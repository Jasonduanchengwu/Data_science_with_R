...
mimiciv_icu_cohort <- mimiciv_icu_cohort %>%
  ...
  select(-c(los, outtime, last_careunit, los, discharge_location, dischtime, deathtime, edouttime, hospital_expire_flag, dod, anchor_age, anchor_year, anchor_year_group)) %>%
  print()
```
