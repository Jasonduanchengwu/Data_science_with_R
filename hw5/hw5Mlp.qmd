...
**Answer: ** wbc is the most important feature in predicting long ICU stays, followed by creatinine of the patient then temperature fahrenheit.

#### 4.2 Interpretation of the results

**Answer: ** The multi-layer perceptron model has cv AUC of 0.620 test AUC of 0.618 and an accuracy of 0.586. The model is interpretable and has a decent performance.