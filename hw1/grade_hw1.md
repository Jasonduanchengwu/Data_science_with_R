...
-   Q3 (20/20)
    ...
    **For 3.7, you should render the file including the file, and only then delete the file and optionally set the chunk to eval = False, rather than including a screenshot**
...
-   Q4 (10/10)
    ...
    **Same as above regarding including screenshots**
...
**No need to add additional hw1Sol.html or .qmd files.**
