...
procedures = procedures %>%
  mutate(
         chartdate = as.POSIXct(chartdate))
...
ggsave(filename = "Q1.1.png", plot = Q1.1, path = "./", width = 8, height = 4, units = c("in"))
```
