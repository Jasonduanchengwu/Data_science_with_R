...
labevents_tble <- tbl(con_bq, "labevents") |>
  ...
  select(subject_id, stay_id, Bicarbonate, Chloride, Creatinine, Glucose, Potassium, Sodium, Hematocrit, wbc) |>
  print(width = Inf)
```
...
mimic_icu_cohort <- icustays_tble |>
  ...
  mutate(anchor_age_real = 
           lubridate::ymd(paste(anchor_year, "-01-01")) -
              years(anchor_age)) |>
  filter(anchor_age_real >= 18) |>
